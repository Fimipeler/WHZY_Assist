...
export default {
  ...
  data() {
    return {
      ...
      menusNameList: [],
      photoList: [
        require("../assets/img/shehui/0.jpg"),
        require("../assets/img/shehui/1.jpg"),
        require("../assets/img/shehui/2.jpg"),
        require("../assets/img/shehui/3.jpg"),
        require("../assets/img/shehui/4.jpg"),
        require("../assets/img/shehui/5.jpg"),
        require("../assets/img/shehui/6.gif"),
        require("../assets/img/shehui/7.gif"),
        require("../assets/img/shehui/8.jpg"),
        require("../assets/img/shehui/9.jpg"),
        require("../assets/img/shehui/10.jpg"),
        require("../assets/img/shehui/11.jpg"),
        require("../assets/img/shehui/12.jpg"),
        require("../assets/img/shehui/13.jpg"),
        require("../assets/img/shehui/14.jpg"),
        require("../assets/img/shehui/15.jpg"),
        require("../assets/img/shehui/16.jpg")
      ],
      config: [
        {
          width: "8vh",
