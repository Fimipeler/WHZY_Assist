...
export default {
  ...
  data() {
    return {
      ...
      menuName: "lvshi",
      menusNameList: [],
      photoList: [require("../assets/img/lvshi/23.gif")],
      config: [
        {
          width: "24vh",
          height: "24vh",
          fontSize: "4vh",
          lineHeight: "6.3vh",
          background: `url(${require("../assets/img/选中按钮.gif")}) center 29vh`,
  ...
  methods: {
    ...
    changeItem(index) {
      ...
      [_this.menusNameList[index], _this.menusNameList[_this.centerDot]] = [
        _this.menusNameList[_this.centerDot],
        _this.menusNameList[index]
      ];
      [_this.photoList[index], _this.photoList[_this.centerDot]] = [
        _this.photoList[_this.centerDot],
        _this.photoList[index]
      ];
