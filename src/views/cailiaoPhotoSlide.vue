    ...
    <div>
      <transition-group name="list" mode="out-in">
        <template v-for="(item, index) in photoList">
          ...
          >
            <img :src="photoList[centerDot]" alt="" />
          </div>
        </template>
      </transition-group>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      photoList: [
        [
          require("../assets/img/cailiao/27-1.gif"),
          require("../assets/img/cailiao/27-2.gif"),
          require("../assets/img/cailiao/27-3.gif")
        ],
        require("../assets/img/cailiao/28.gif"),
        require("../assets/img/cailiao/29.gif"),
        require("../assets/img/cailiao/30.gif"),
        require("../assets/img/cailiao/31.gif")
      ],
      config: [
        {
          width: "15vh",
          height: "15vh",
          fontSize: "2.3vh",
          transform: "rotate(-51deg) translate(640px, -50%)"
        },
        {
          width: "20vh",
          height: "20vh",
          fontSize: "3vh",
          transform: "rotate(-30deg) translate(600px,-50%)"
        },
        {
          width: "33vh",
          height: "33vh",
          fontSize: "4.5vh",
          background: `url(${require("../assets/img/选中按钮.gif")}) center -2vh`,
          backgroundSize: `38vh 38vh !important`,
          transform: "rotate(0deg) translate(460px,-50%)"
        },
        {
          width: "20vh",
          height: "20vh",
          fontSize: "3vh",
          transform: "rotate(30deg) translate(490px,-50%)"
        },
        {
          width: "15vh",
          height: "15vh",
          fontSize: "2.3vh",
          transform: "rotate(57deg) translate(510px, -50%)"
        }
      ],
      warpConfig: false,
      roundConfig: false,
  ...
  mounted() {
    ...
    console.log(this.menusNameList);
    // 取中间数
    this.centerDot = Math.floor(this.menusNameList.length / 2);
    // console.log(this.photoList[0][this.$route.params.num.slice(0, 1)]);
    if (this.$route.params.num.length >= 3) {
      this.photoList[0] = this.photoList[0][this.$route.params.num.slice(2, 3)];
      ...
      this.photoList[0] = this.photoList[0][0];
      // 上级路由选择下标
      this.$nextTick(() => {
  ...
  methods: {
    ...
    // 点击效果
    changeItem(index) {
      console.log(this.menusNameList[index]);
      let _this = this;
      let temp = "";
      let tempPhoto = "";
