...
export default {
  ...
  data() {
    return {
      ...
      menusNameList: [],
      photoList: [
        require("../assets/img/sifa/1.gif"),
        require("../assets/img/sifa/2.gif"),
        require("../assets/img/sifa/3.gif"),
        require("../assets/img/sifa/4.gif"),
        require("../assets/img/sifa/5.gif"),
        require("../assets/img/sifa/6.gif"),
        require("../assets/img/sifa/7.gif"),
        [
          require("../assets/img/sifa/22-1.gif"),
          require("../assets/img/sifa/22-2.gif"),
          require("../assets/img/sifa/22-3.gif"),
          require("../assets/img/sifa/22-4.gif")
        ],
        [
          require("../assets/img/sifa/23-1.gif"),
          require("../assets/img/sifa/23-2.gif"),
          require("../assets/img/sifa/23-3.gif"),
          require("../assets/img/sifa/23-4.gif")
        ]
      ],
      config: [
        {
  ...
  mounted() {
    ...
    if (this.$route.params.num.length >= 4) {
      this.photoList[7] = this.photoList[7][this.$route.params.num.slice(3, 4)];
      this.photoList[8] = this.photoList[8][this.$route.params.num.slice(3, 4)];
      // 上级路由选择下标
      this.$nextTick(() => {
        this.changeItem(this.$route.params.num.slice(0, 1));
      });
    } else {
      this.photoList[7] = this.photoList[7][0];
      this.photoList[8] = this.photoList[8][0];
      // 上级路由选择下标
      this.$nextTick(() => {
  ...
  methods: {
    ...
    changeItem(index) {
      ...
      console.log("click", this.centerDot);
      let _this = this;
      let temp = "";
      let tempPhoto = "";
